...
const PurpleKnightADOverview = () => {
  const CATEGORY = 'Purple Knight AD'
  ...
  // Purple Knight AD metrics
  const noteValue = getLatestValue('Note')
  const noteIndicator = getIndicator(noteValue, dataManager.getReferenceValue('Purple Knight AD', 'Note'), 'Note')
  
  const ioesFoundValue = getLatestValue('IOEs Found')
  const ioesFoundIndicator = getIndicator(ioesFoundValue, dataManager.getReferenceValue('Purple Knight AD', 'IOEs Found'), 'IOEs Found')
  
  const criticalIOEsValue = getLatestValue('Critical IOEs')
  const criticalIOEsIndicator = getIndicator(criticalIOEsValue, dataManager.getReferenceValue('Purple Knight AD', 'Critical IOEs'), 'Critical IOEs')
    ...
    <div className="space-y-6 mb-8">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-5 gap-6">
        ...
        <div className="lg:col-span-2">
          <div className="bg-white rounded-lg shadow-lg border-2 border-purple-200 p-8 text-center hover:shadow-xl transition-all duration-300 aspect-square flex flex-col justify-center metric-card">
            <div className="mb-4">
            ...
            <div className="text-sm text-gray-600">
              Target: {dataManager.getReferenceValue('Purple Knight AD', 'Note')}
            </div>
        ...
        <div className="lg:col-span-3">
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 h-full">
            {/* IOEs Found */}
            <div className="bg-white rounded-lg shadow-lg border-2 border-purple-200 p-4 hover:shadow-xl transition-all duration-300 flex aspect-square metric-card">
              ...
              <div className="flex-1 flex flex-col justify-center">
                ...
                <div className="text-xs text-gray-600">
                  Target: {dataManager.getReferenceValue('Purple Knight AD', 'IOEs Found')}
                </div>
              </div>
            ...
            <div className="bg-white rounded-lg shadow-lg border-2 border-purple-200 p-4 hover:shadow-xl transition-all duration-300 flex aspect-square metric-card">
              ...
              <div className="flex-1 flex flex-col justify-center">
                ...
                <div className="text-xs text-gray-600">
                  Target: {dataManager.getReferenceValue('Purple Knight AD', 'Critical IOEs')}
                </div>
              </div>
...
export default PurpleKnightADOverview
